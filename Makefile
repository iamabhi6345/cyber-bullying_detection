...
# 	| more $(shell test $(shell uname) = Darwin && echo '--no-init --raw-control-chars')
 ...
 WHAT_TO_PRINT = "ABHISHEK KUMAR"
LIST_OUTPUT = $(shell ls)
...
# '''
# 	@ it helps to print commands as well as output
# 	******abhi@ABHISHEK:/mnt/f/project/03-basics$ make print-hello-world
# 	echo "hello world"
# 	hello world

# 	******abhi@ABHISHEK:/mnt/f/project/03-basics$ make print-hello-world1
# 	hello world
# '''
